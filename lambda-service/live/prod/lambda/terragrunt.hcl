...
dependency "rds" {
  ...
  mock_outputs = {
    db_instance_address = "prod-database.mock.us-east-1.rds.amazonaws.com"
...
inputs = {
  ...
  environment_variables = {
    ...
    DB_PASSWORD = "change-me-secure-prod-password"
  }
