...
dependency "ecr" {
  ...
  mock_outputs = {
    repository_url = "123456789012.dkr.ecr.us-east-1.amazonaws.com/staging-lambda-cron-service"
    worker_repository_url = "123456789012.dkr.ecr.us-east-1.amazonaws.com/staging-lambda-cron-worker"
  }
  mock_outputs_allowed_terraform_commands = ["init", "plan", "validate"]
}
